...
export default function CategoriesPage() {
    ...
    const { data, loading, error: categoriesError, refetch } = useApi<Iarsip>(API_ROUTES.arsip.analisis.sumber);
    ...
    return (
        <div>
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Sumber Data</h1>
                <p className="text-gray-600">Informasi Aktivitas Pendataan Bidang & Sekretariat</p>
            </div>
