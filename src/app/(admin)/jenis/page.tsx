...
export default function CategoriesPage() {
    ...
    const { data, loading, error: categoriesError, refetch } = useApi<Iarsip>(API_ROUTES.arsip.pendataan);
    ...
    return (
        <div>
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Klasifikasi Data Arsip</h1>
                <p className="text-gray-600">Informasi Pengelompokan data berdasarkan Kode Klasifikasi</p>
            </div>
