...
interface FileUploadProps {
    ...
    className?: string;
    /** Enable multiple file upload. Defaults to false (single file only) */
    multiple?: boolean;
}
...
export default function FileUpload({
    ...
    return (
        ...
        >
            <div className="group relative w-full rounded-lg bg-white border border-gray-200">
                <div
                    className={cn(
                        "relative mx-auto w-full overflow-hidden rounded-lg bg-gray-50 py-4 ",
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute inset-x-0 bottom-0 h-[20%] bg-gradient-to-t from-emerald-500/10 to-transparent" />
                        <div className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-emerald-500/10 to-transparent" />
                        <div className="absolute inset-y-0 right-0 w-[20%] bg-gradient-to-l from-emerald-500/10 to-transparent" />
                        <div className="absolute inset-[20%] bg-emerald-500/5 rounded-lg transition-all duration-300 animate-pulse" />
                    </div>
                            ...
                            {status === "idle" || status === "dragging" ? (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-4/5 flex items-center justify-center gap-2 rounded-lg bg-emerald-500 px-4 py-2 text-xs font-medium text-white transition-all duration-200 hover:bg-emerald-600 group"
                                    >
                                ...
                                >
                                    ...
                                    <button
                                        onClick={resetState}
                                        type="button"
                                        className="w-4/5 flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-xs font-medium text-gray-700 transition-all duration-200 hover:bg-gray-50"
                                    >
                                        Cancel
                                    </button>
                                </motion.div>
                    ...
                    <AnimatePresence>
                        {error && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}
                                className="absolute bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 bg-red-50 border border-red-200 rounded-lg"
                            >
