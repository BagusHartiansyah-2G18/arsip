module.exports = [
"[project]/.next-internal/server/app/api/(arsip)/pendataan/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/(arsip)/pendataan/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(req, context) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$userGuard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["portal"])(req, async (token)=>{
        try {
            ...
            const formAs = formData.get('formAs');
            const formNm = formData.get('formNm');
            const formVal = formData.get('formVal');
...
async function DELETE(req, context) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$userGuard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["portal"])(req, async (token)=>{
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(remaining);
        } catch (error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: error instanceof Error ? error.message : String(error)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bfbbde21._.js.map