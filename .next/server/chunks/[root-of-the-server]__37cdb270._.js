module.exports = [
"[project]/.next-internal/server/app/api/(arsip)/analisis/sumber/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/(arsip)/analisis/sumber/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$userGuard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["portal"])(req, async (v)=>{
        ...
        const bidangIds = groupedData.map((item)=>item.idBidang);
        ...
        const data = groupedData.map((item)=>{
            const bidang = bidangData.find((b)=>b.id === item.idBidang);
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37cdb270._.js.map